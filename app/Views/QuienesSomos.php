<div class = "txt-pag">
    ...
    <br>
        ...
        <br>
            ...
            <div class="linea-QS1">
                <div class="col-2">
                <p>Tras cinco años de intenso trabajo y crecimiento sostenido, en 2003 lograron un hito: Xport fue seleccionada como la primera empresa distribuidora oficial en Latinoamérica de la prestigiosa marca de autos de lujo Maserati. Este logro marcó un antes y un después, posicionando a Xport como un referente en la comercialización de vehículos de alta gama en la región.</p>
                </div>
                <div class="col-2">
            ...
            <div class="linea-QS1">
                <div class="col-2">
                <p>Actualmente, Xport cuenta con un amplio catálogo de autos de lujo, una red de concesionarios estratégicamente ubicados en Argentina y un equipo de profesionales altamente capacitados para garantizar una experiencia de compra única. Cada paso que damos reafirma nuestro compromiso con la excelencia, el prestigio y la satisfacción de nuestros clientes.</p>
                </div>
                <div class="col-2">
